...
var i_32400 = (0);
while(true){
if((i_32400 < arr.length)){
(arr[i_32400] = null);

var G__32401 = (i_32400 + (1));
i_32400 = G__32401;
continue;
} else {
}
...
var i_32408 = (self__.level + (1));
while(true){
if((i_32408 <= (new_level + (1)))){
(update[i_32408] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32410 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32410[i]));
} else {
x__$2.forward.push((((i < links_32410.length))?(links_32410[i]):null));
}

if((i < links_32410.length)){
(links_32410[i] = x__$2);
} else {
links_32410.push(x__$2);
}
...
var i_32412 = (0);
while(true){
if((i_32412 <= self__.level)){
var links_32413 = (update[i_32412]).forward;
if((x__$1 === (((i_32412 < links_32413.length))?(links_32413[i_32412]):null))){
(links_32413[i_32412] = (x__$1.forward[i_32412]));

var G__32414 = (i_32412 + (1));
i_32412 = G__32414;
continue;
} else {
var G__32415 = (i_32412 + (1));
i_32412 = G__32415;
continue;
}
} else {
...
var G__32417 = nx;
var G__32418 = (level__$1 - (1));
x = G__32417;
level__$1 = G__32418;
continue;
} else {
var G__32419 = x;
var G__32420 = (level__$1 - (1));
x = G__32419;
level__$1 = G__32420;
continue;
}
