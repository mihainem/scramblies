...
}catch (e30347){var _e__26860__auto__ = e30347;
return false;
...
}catch (e30349){var _e__26860__auto__ = e30349;
return false;
...
}catch (e30351){var _e__26860__auto__ = e30351;
return false;
...
}catch (e30353){var _e__26860__auto__ = e30353;
return false;
...
}catch (e30355){var _e__26860__auto__ = e30355;
return false;
}})())){
...
}catch (e30357){var _e__26860__auto__ = e30357;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__30359 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30360 = (function (){var or__4223__auto__ = config;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30360);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30359);
}});
});
...
return (function() { 
var G__30368__delegate = function (args){
...
while (G__30369__i < G__30369__a.length) {G__30369__a[G__30369__i] = arguments[G__30369__i + 0]; ++G__30369__i;}
  args = new cljs.core.IndexedSeq(G__30369__a,0,null);
} 
return G__30368__delegate.call(this,args);};
G__30368.cljs$lang$maxFixedArity = 0;
G__30368.cljs$lang$applyTo = (function (arglist__30370){
var args = cljs.core.seq(arglist__30370);
return G__30368__delegate(args);
});
