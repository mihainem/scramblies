...
var o27626 = temp__5751__auto__;
var temp__5751__auto____$1 = (o27626["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o27627 = temp__5751__auto____$1;
return (o27627["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26850__auto__ = f;
return (o__26850__auto__["toString"]).call(o__26850__auto__);
} else {
return "";
}
}catch (e27640){var _ = e27640;
return "";
}});
...
try{var o__26850__auto___28016 = t;
(o__26850__auto___28016["cljs$lang$ctorPrWriter"]).call(o__26850__auto___28016,t,writer);
}catch (e27650){var __28018 = e27650;
}
...
var char_code = (function (){var o__26850__auto__ = (new String(char$));
return (o__26850__auto__["charCodeAt"]).call(o__26850__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26850__auto__ = String;
return (o__26850__auto__["fromCharCode"]).call(o__26850__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27669 = num_code;
switch (G__27669) {
case (1):
return (185);
...
var o__26850__auto__ = String;
return (o__26850__auto__["fromCharCode"]).call(o__26850__auto__,superscript_code);
});
/**
...
}catch (e27685){var _e__26860__auto__ = e27685;
return false;
}})())){
...
var len__4829__auto___28025 = arguments.length;
var i__4830__auto___28026 = (0);
while(true){
if((i__4830__auto___28026 < len__4829__auto___28025)){
args__4835__auto__.push((arguments[i__4830__auto___28026]));

var G__28027 = (i__4830__auto___28026 + (1));
i__4830__auto___28026 = G__28027;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27714){
var vec__27715 = p__27714;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27715,(0),null);
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27707){
var G__27708 = cljs.core.first(seq27707);
var seq27707__$1 = cljs.core.next(seq27707);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27708,seq27707__$1);
}));
...
var vec__27726 = cljs.core.split_with((function (p1__27725_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27725_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27726,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27726,(1),null);
...
var vec__27740 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27740,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27740,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28035 = cljs.core.rest(remaining_tokens);
var G__28036 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28035;
name_tokens = G__28036;
continue;
} else {
...
var vec__27750 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27750,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27750,(1),null);
var vec__27753 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27753,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27753,(1),null);
var vec__27756 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27756,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27756,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27756,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27756,(3),null);
...
var vec__27777 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27777,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27777,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27777,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27777,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27777,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27777,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__27782 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27782,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27782,(1),null);
var vec__27785 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27785,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27785,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27824 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27824) : devtools.munging.parse_fn_info_deep.call(null,G__27824));
})()));
}
} else {
return fn_info;
...
var G__28047 = (arity + (1));
var G__28048 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27868){
var vec__27869 = p__27868;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27869,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27869,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27882_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27882_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27883_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27883_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27890){
var vec__27892 = p__27890;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27892,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27884){
var G__27885 = cljs.core.first(seq27884);
var seq27884__$1 = cljs.core.next(seq27884);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27885,seq27884__$1);
}));
...
var map__27911 = options;
var map__27911__$1 = cljs.core.__destructure_map(map__27911);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27911__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27911__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27911__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27911__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27912 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27912,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27912,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27912,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27912,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27912,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27912,(5),null);
...
var o__26850__auto__ = f;
return (o__26850__auto__["getBasis"]).call(o__26850__auto__);
});
/**
...
}catch (e27972){var _e__26860__auto__ = e27972;
...
var G__28083 = (obj[cljs.core.first(path)]);
var G__28084 = cljs.core.rest(path);
obj = G__28083;
path = G__28084;
continue;
} else {
...
var _STAR_ = (function (accum,p__27990){
var vec__27991 = p__27990;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27991,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27991,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28002){
var vec__28003 = p__28002;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28003,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28003,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28003,(2),null);
...
var post_process = (function (p__28008){
var vec__28009 = p__28008;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28009,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28009,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28006_SHARP_){
return (obj[cljs.core.first(p1__28006_SHARP_)]);
}),sorted_matches);
