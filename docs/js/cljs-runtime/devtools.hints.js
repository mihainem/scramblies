...
var map__28922 = top_item;
var map__28922__$1 = cljs.core.__destructure_map(map__28922);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28922__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28922__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28922__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e28919){var _e = e28919;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___28998 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___28998)){
var seen_errors_28999 = temp__5751__auto___28998;
if(cljs.core.truth_(seen_errors_28999.has(self))){
} else {
seen_errors_28999.add(self);

var temp__5753__auto___29000 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___29000)){
var sense_29001 = temp__5753__auto___29000;
