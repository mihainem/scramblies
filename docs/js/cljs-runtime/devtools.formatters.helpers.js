...
var G__28878 = devtools.prefs.pref(v);
v = G__28878;
continue;
} else {
return v;
...
}catch (e28830){var _e__26860__auto__ = e28830;
return false;
}})();
...
}catch (e28835){var _e__26860__auto__ = e28835;
return false;
}})();
...
}catch (e28837){var _e__26860__auto__ = e28837;
return false;
}}
}
});
...
var vec__28848 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28848,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28848,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28853_SHARP_);
}),template);
});
