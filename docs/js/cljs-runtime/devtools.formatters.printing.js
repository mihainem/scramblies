...
var len__4829__auto___29119 = arguments.length;
var i__4830__auto___29120 = (0);
while(true){
if((i__4830__auto___29120 < len__4829__auto___29119)){
args__4835__auto__.push((arguments[i__4830__auto___29120]));

var G__29121 = (i__4830__auto___29120 + (1));
i__4830__auto___29120 = G__29121;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29042){
var G__29043 = cljs.core.first(seq29042);
var seq29042__$1 = cljs.core.next(seq29042);
var G__29044 = cljs.core.first(seq29042__$1);
var seq29042__$2 = cljs.core.next(seq29042__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29043,G__29044,seq29042__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29072_SHARP_){
return (!((cljs.core.meta(p1__29072_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29087__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29092){var _e__26860__auto__ = e29092;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e29094){var _e__26860__auto__ = e29094;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__29101 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__29102 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__29102);

try{var map__29103 = opts;
var map__29103__$1 = cljs.core.__destructure_map(map__29103);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29103__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__29101);
}});
...
var temp__5751__auto___29194 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___29194)){
var managed_print_level_29196 = temp__5751__auto___29194;
var _STAR_print_level_STAR__orig_val__29107_29197 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29108_29199 = managed_print_level_29196;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29108_29199);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__29106_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29106_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29107_29197);
}} else {
job_fn();
}
